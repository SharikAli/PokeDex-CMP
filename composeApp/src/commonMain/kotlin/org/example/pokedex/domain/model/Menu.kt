...
val homeMenus = listOf(
    ...
    Menu(id = 5, title = "Legendary", color = Mustard, icon = Res.drawable.master_ball, onClick = HomeIntent.NavigateToLegendaryPokeDex),
    Menu(id = 6, title = "Mega PokeDex", color = Purple.copy(alpha = .7f), icon = Res.drawable.electric, onClick = HomeIntent.NavigateToMegaPokeDex),
)
